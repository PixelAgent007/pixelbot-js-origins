...
module.exports = new Origin({
    ...
    impact: 2,
    description:
        'A decendant of the common housecat. Cats can be found using their natural abilities to squeeze into small, hard to reach places.',
    author: 'KitCat#0962',
    ...
    pros: [
        new Power({
            name: 'Agile',
            description:
                'You have a wide variety of mevement options including a wall jump.',
        }),
        new Power({
            name: 'Crawl',
            description:
                'You can crawl on the ground at the press of a button (while sprinting)',
        }),
        new Power({
            name: 'Quick Attack',
    ...
    passives: [
        ...
        new Power({
            name: 'Fishy Palate',
            description:
                'You are able to get more out of raw fish than others would.',
        }),
        new Power({
            name: 'Pickup',
    ...
    cons: [
        new Power({
            name: 'Fragile',
            description:
                "You can't take too much of a beating. You only have 5 hearts.",
        }),
        new Power({
            name: 'Lightweight',
        ...
        new Power({
            name: 'Hydrophobia',
            description:
                'You fear water for no apperent reason. If it ever touches you, your visoin starts to distort.',
        }),
    ],
});
