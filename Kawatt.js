...
module.exports = new Origin({
    ...
    actives: [
        ...
        new Power({
            ...
            description:
                "You shoot a ray that absorbs the color from an entity.",
        }),
        new Power({
            name: "Explosive Glint",
            description:
                "You can shoot a firework and are immune to firework damage.",
        }),
        new Power({
            name: "Color Swap",
    ...
    pros: [
        new Power({
            name: "Odonata Wings",
            description:
                "You have the delicate wings of a dragonfly. Flying with them will slowly decrease your color meter.",
        }),
        new Power({
            name: "Erratic Crystal",
            description:
                "You are immune to kinetyc damage and bounce on walls, but might combust because of the friction. Each time you hit a wall, you will leave a burst of color.",
        }),
        new Power({
    ...
    passives: [
        new Power({
            ...
            description:
                "You can refill your color bar with dyes and by being around geodes.",
        }),
        new Power({
            name: "Camouflage",
        ...
        new Power({
            name: "Shiny",
            description:
                "You are slightly transparent. The glowing effect lasts longer.",
        }),
    ],
    cons: [
        new Power({
        ...
        new Power({
            ...
            description:
                "Darkness weakens you and makes you lose the ability to regenerate naturally.",
        }),
    ],
});
